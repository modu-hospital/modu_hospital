...
describe('User Service Unit Test', () => {
    ...
    describe('editUserProfile', () => {
        it('should call userRepository.editUserProfile once with proper argument',async ()=>{
            const {userId,address,phone,name} = {userId:1,address:'서울시',phone:'010',name:'arthur'}
            ...
            expect(mockUserRepository.editUserProfile).toHaveBeenCalledWith(userId,address,phone,name)
        })
        it('should return proper data', async ()=>{
    ...
    describe('getApprovedReservation', () => {
        it('should call proper repository function one with proper argument', async () => {
            ...
            expect(mockReservationRepository.getApprovedReservation).toHaveBeenCalledWith(userId,page)
        })
        it('should return proper data', async () => {
    ...
    describe('getWaitingReservation', () => {
        it('should call proper repository function one with proper argument', async () => {
            ...
            expect(mockReservationRepository.getWaitingReservation).toHaveBeenCalledWith(userId,page)
        })
        it('should return proper data', async () => {
            const reservationData = [
                {
    ...
    describe('getDoneOrReviewedReservation', () => {
        it('should call proper repository function one with proper argument', async () => {
            ...
            expect(mockReservationRepository.getDoneOrReviewedReservation).toHaveBeenCalledWith(userId,page)
        })
        it('should return proper data', async () => {
            const reservationData = [
                {
    ...
    describe('getCanceledReservation', () => {
        it('should call proper repository function one with proper argument', async () => {
            ...
            expect(mockReservationRepository.getCanceledReservation).toHaveBeenCalledWith(userId,page)
        })
        it('should return proper data', async () => {
            const reservationData = [
                {
